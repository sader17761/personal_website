...
<head>
	...
	<script src="http://maps.googleapis.com/maps/api/js?key=AIzaSyBLoVYRMjWBFsCbscHTgtmdJ1ygi-yN1gk"></script>
	<script type="text/javascript" src="vendors/js/gmaps.js"></script>

	<!-- Normalize CSS and GRID CSS (these must go before the Custom CSS)-->
	<link rel="stylesheet" type="text/css" href="vendors/css/normalize.css">
	<link rel="stylesheet" type="text/css" href="vendors/css/grid.css"> <!-- from www.responsivegridsystem.com -->
	...
	<link rel="mask-icon" href="/resources/icons/safari-pinned-tab.svg">
...
<body>
	...
	<section class="section-cities" id="cities">
		...
		<div class="row js--wp-3">
			<div class="col span-1-of-4 box">
				<img src="resources/img/lisbon-3.jpg" alt="Lisbon Image">
				<h3>Lisbon</h3>
			...
			<div class="col span-1-of-4 box">
				<img src="resources/img/san-francisco.jpg" alt="San Francisco Image">
				<h3>San Francisco</h3>
				<div class="city-feature">
					<i class="ion-ios-person icon-small"></i>
					3700+ happy eaters
			...
			<div class="col span-1-of-4 box">
				<img src="resources/img/berlin.jpg" alt="Berlin Image">
				<h3>Berlin</h3>
				<div class="city-feature">
					<i class="ion-ios-person icon-small"></i>
					2300+ happy eaters
			...
			<div class="col span-1-of-4 box">
				<img src="resources/img/london.jpg" alt="London Image">
				<h3>London</h3>
				<div class="city-feature">
					<i class="ion-ios-person icon-small"></i>
					1200+ happy eaters
			...
			<div class="col span-1-of-3">
				<div class="plan-box">
					<div>
						...
						<p class="plan-price-meal">&nbsp;</p> <!-- this will add a space -->
					</div>
					<div>
						<ul>
	...
	<!-- Beginning of Map and Form Section -->
	<div class="map-box">
		<div class="map"></div>
...
<!-- from www.jsdelivr.com (search 'respond')-->
<script src="https://cdn.jsdelivr.net/respond/1.4.2/respond.min.js"></script>
<!-- from www.jsdelivr.com (search 'html5shiv')-->
<script src="https://cdn.jsdelivr.net/g/respond@1.4.2,html5shiv@3.7.3(html5shiv-printshiv.min.js)"></script>
<!-- from www.jsdelivr.com (search 'selectivizer')-->
<script src="https://cdn.jsdelivr.net/g/respond@1.4.2,html5shiv@3.7.3(html5shiv-printshiv.min.js),selectivizr@1.0.3b"></script>
